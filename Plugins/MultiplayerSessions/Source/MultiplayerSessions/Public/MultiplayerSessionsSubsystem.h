...
private:
	...
	//create  last session settings 
	TSharedPtr<FOnlineSessionSettings> LastSessionSettings;
	TSharedPtr <FOnlineSessionSearch> LastSessionSearch;
	

	//to add online session interface delegate list
	//also we will bind our MultiplayerSessionsSubsystem internal callbacks to these
	...
	//creating variable for create session to destry sessions
